      ...
      <div style={{height: "92%"}}>
        <div style={{height: "100%"}}>
          <div style={{display: "flex", justifyContent: "center"}}>
            <h1 style={{position: "relative", top: "5px", height: "0", margin: "0", color: "white", fontFamily: "Staatliches", fontSize: "6em"}}>ELEVATE YOUR ADVENTURE</h1>
          </div>
          <div style={{display: "flex", justifyContent: "center"}}>
            <h1 style={{position: "relative", top: "120px", height: "0", margin: "0", color: "white", fontFamily: "Staatliches", fontSize: "3em"}}>START PLANNING TODAY</h1>
          </div>
